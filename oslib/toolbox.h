...
typedef struct toolbox_child                    toolbox_child;
...
#else
typedef int                                     toolbox_object_descriptor;
#endif
...
#else
typedef int toolbox_sprite_area_reference;
#endif
...
#define toolbox_SHOW_AS_CHILD_WINDOW            ((toolbox_show_flags) 0x4u)
