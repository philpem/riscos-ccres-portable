 ...
 *
 * Description:   Returns the status of a given drive - RISC OS 3.6+
 *
 * Input:         drive_no - value of R1 on entry
 *                instance - value of R8 on entry
 *
 ...
 *
 * Description:   Verifies a disc - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                size - value of R4 on entry
 ...
 *
 * Description:   Reads sectors from a disc - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Writes sectors to a disc - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Reads a track from a floppy disc - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Reads a hard disc ID - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Writes a track to a disc - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Formats a track of a disc - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                track_format - value of R4 on entry
 ...
 *
 * Description:   Seeks to a disc location - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                instance - value of R8 on entry
 ...
 *
 * Description:   Does a restore operation for a disc - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                instance - value of R8 on entry
 ...
 *
 * Description:   Steps a floppy disc in one track - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                instance - value of R8 on entry
 *
 ...
 *
 * Description:   Steps a floppy disc out one track - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                instance - value of R8 on entry
 *
 ...
 *
 * Description:   Reads sectors of a disc using the RMA cache - RISC OS
 *                3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 ...
 *
 * Description:   Does a specify operation on a hard disc - RISC OS 3.6+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                instance - value of R8 on entry
 ...
 *
 * Description:   Verifies a disc - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                size - value of R4 on entry
 ...
 *
 * Description:   Reads sectors from a disc - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Writes sectors to a disc - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Reads a track from a floppy disc - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Reads a hard disc ID - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Writes a track to a disc - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Formats a track of a disc - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                track_format - value of R4 on entry
 ...
 *
 * Description:   Seeks to a disc location - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                instance - value of R8 on entry
 ...
 *
 * Description:   Does a restore operation for a disc - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                instance - value of R8 on entry
 ...
 *
 * Description:   Steps a floppy disc in one track - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                instance - value of R8 on entry
 *
 ...
 *
 * Description:   Steps a floppy disc out one track - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                instance - value of R8 on entry
 *
 ...
 *
 * Description:   Reads sectors of a disc using the RMA cache - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                data - value of R3 on entry
 ...
 *
 * Description:   Does a specify operation on a hard disc - RISC OS 5+
 *
 * Input:         flags - value of R1 on entry
 *                disc_addr - value of R2 on entry
 *                instance - value of R8 on entry
 ...
 *
 * Description:   Returns FileCore feature flags - RISC OS 5+
 *
