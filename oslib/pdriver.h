 ...
 *                dumper supports with the current printer driver - RISC OS
 *                3.5+
 *
 * Input:         pdumper_no - value of R1 on entry
 *
 ...
 *
 * Description:   Returns a bit mask showing which strip types a printer
 *                dumper supports with a specified printer driver - RISC OS
 *                3.5+
 *
 * Input:         pdumper_no - value of R1 on entry
 *                type - value of R8 on entry
 ...
 *
 * Description:   Configures the current printer driver - RISC OS 3+
 *
 * Input:         pdumper_no - value of R1 on entry
 ...
 *
 * Description:   Configures the current printer driver - RISC OS 4+
 *
 * Input:         pdumper_no - value of R1 on entry
 *                ensure_command - value of R2 on entry
 *                configuration_data1 - value of R3 on entry
 ...
 *
 * Description:   Returns the dimensions of a JPEG image in memory - RISC
 *                OS 3.6+
 *
 ...
 *
 * Description:   Returns the dimensions of a JPEG image in a file - RISC
 *                OS 3.6+
 *
 ...
 *
 * Description:   Plots a JPEG image from memory - RISC OS 3.6+
 *
 ...
 *
 * Description:   Plots a JPEG image from a file - RISC OS 3.6+
 *
