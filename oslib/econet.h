 ...
 *
 * Description:   Returns the handles of open transmit blocks - RISC OS
 *                3.5+
 *
 ...
 *
 * Description:   Returns the Econet clock period and frequency - RISC OS
 *                3.5+
 *
 ...
 * Function:      econetv()
 *
 * Description:   Calls EconetV vector directly
 *
