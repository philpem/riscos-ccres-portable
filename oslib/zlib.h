 ...
 **********************************/
#undef  ZLib_CompressReturnSizes
#define ZLib_CompressReturnSizes                0x53AC0
#undef  XZLib_CompressReturnSizes
#define XZLib_CompressReturnSizes               0x73AC0
#undef  ZLib_Compress
#define ZLib_Compress                           0x53AC0
#undef  XZLib_Compress
#define XZLib_Compress                          0x73AC0
#undef  ZLib_DecompressReturnSizes
#define ZLib_DecompressReturnSizes              0x53AC1
#undef  XZLib_DecompressReturnSizes
#define XZLib_DecompressReturnSizes             0x73AC1
